...
internal static class SelfTests
{
    public static int Run()
    {
        try
        {
            ...
            Require(defaults.InvoiceJsonPath.EndsWith("invoice.json", StringComparison.Ordinal), "default invoice path parsed");
            ...
            InvoiceInput invoice = InvoiceDataLoader.Load(Path.Combine("data", "invoice.json"));
